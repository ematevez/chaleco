...
class ChalecoApp(App):
    ...
    def crear_pdf_informe_destruccion(self):
        ...
        def agregar_registro(chaleco, y_position):
            c.setFont("Helvetica", 10)
            # Asignar valores para los campos, reemplazando `None` con una cadena vacía
            ...
            return y_position - 15  # Ajuste de espacio entre registros
...
#!=============================PARTE DE FUSION=======================
    def combinar_imagenes(self, qr_id):
        ...
        imagen_final_path = os.path.join(img_folder, f"{qr_id}.png")
        ...
        # Agregar etiquetas de "ENTRADA" y "SALIDA"
