...
class DatePicker(BoxLayout):
    def __init__(self, on_select, **kwargs):
        ...
        self.spinner_year = Spinner(
            text='Año',
            values=[str(year) for year in range(2000, 2031)],
            size_hint=(1, None),
            height=44
        )
...
class ChalecoApp(App):
    ...
    def build(self):
        ...
        self.ip_destino = '192.168.1.38'  # Esta es la IP inicial por defecto
    ...
    def create_widgets(self):
        ...
        self.boton_config_ip = Button(size_hint=(None, None), size=(44, 44), background_normal='engranaje.png')
        ...
        fecha_fabricacion_layout = BoxLayout(orientation='horizontal', size_hint=(1, None), height=44, spacing=10)
        ...
        fecha_vencimiento_layout = BoxLayout(orientation='horizontal', size_hint=(1, None), height=44, spacing=10)
...
# Validar fechas (vencimiento mayor a fabricación)
    ...
    def mostrar_popup(self, titulo, mensaje, boton_texto='Cerrar', boton_callback=None, auto_close_time=None):
        ...
        layout = BoxLayout(orientation='vertical', padding=10, spacing=10)
        layout.add_widget(Label(text=mensaje, size_hint=(1, 0.8), halign='center'))
