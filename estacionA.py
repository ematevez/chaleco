...
def cambiar_foco_con_tecla(window, keycode, *args):
    focusable_widgets = App.get_running_app().focusable_widgets
    focused_widget = Window.focused_widget

    if focused_widget in focusable_widgets:
        current_index = focusable_widgets.index(focused_widget)
    ...
    def build(self):
        ...
        for widget in self.focusable_widgets:
            if isinstance(widget, TextInput):
                widget.bind(text=convertir_a_mayusculas)
        ...
        # Vincular teclas
        Window.bind(on_key_down=cambiar_foco_con_tecla)
